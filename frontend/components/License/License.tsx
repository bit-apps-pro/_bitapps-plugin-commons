...
import { LuBadgeCheck, LuCheck, LuCrown } from 'react-icons/lu'
...
/**
 * License panel for the free build. Keeps the upgrade and activation paths but not
 * deactivation, because the plugin only serves the pro build once a license is
 * valid — a valid license means License.pro is rendering instead of this.
 *
 * Activation must stay here: a user who installed the pro plugin but has not
 * activated it yet is still served this free build.
 */
